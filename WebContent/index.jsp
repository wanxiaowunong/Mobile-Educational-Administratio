...
<body style='background:url(images/gate.jpg) no-repeat;background-size:100%' >

<form action="login?action=onOK" method="post" onsubmit="return onOK()">
<table cols="2" bgcolor="skyblue" margin="auto" align="center">
<tr><td colspan="2"><th>教务后台管理系统</th> </td>
</tr>
